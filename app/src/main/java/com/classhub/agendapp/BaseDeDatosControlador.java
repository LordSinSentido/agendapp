...
public class BaseDeDatosControlador extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase baseDeDatos) {
        ...
        String crearHorario = "create table horarios (id integer primary key autoincrement not null, titulo text not null, descripcion text, prioridad int not null, tipo text not null, recordatorio text, fechaDeFin text not null, horaDeInicio time not null, horaDeFin time not null, ubicacion text)";
